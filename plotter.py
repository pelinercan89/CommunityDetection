...
def save_predicted_networks(results):
    for result in results.values():
        ...
        ig.plot(clusters, output_file, **visual_style, mark_groups=True, inline=True, vertex_label=result.ig_graph.vs.indices, layout=result.layout)
...
def save_original_networks(datasets):
    for dataset in datasets:
        ...
        ig.plot(clusters, output_file, **visual_style, mark_groups=True, inline=True, vertex_label=dataset.ig_graph.vs.indices, layout=dataset.layout)
...
def plot_data(results, datasets):
    metrics = ['shen_modularity', 'mgh_nmi', 'f_score', 'my_modularity', 'runtime']
